...
[graykode/nlp-tutorial](https://github.com/graykode/nlp-tutorial): each chapter
focuses on one core idea, links directly to runnable code and notebooks, and keeps
the implementation close enough to the math that you can inspect it.
...
- 00. [Why Graph Learning](chapters/00-why-graph-learning/README.md) - Map product questions to graph tasks.
  ...
  - Notebook - [Jupyter](notebooks/00-why-graph-learning.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/00-why-graph-learning.ipynb)
...
- 01. [Graph Basics](chapters/01-graph-basics/README.md) - Turn records into `edge_index`, features, labels, and adjacency.
  ...
  - Notebook - [Jupyter](notebooks/01-graph-basics.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/01-graph-basics.ipynb)
...
- 02. [Message Passing By Hand](chapters/02-message-passing-by-hand/README.md) - Trace aggregation, self-loops, and normalization.
  ...
  - Notebook - [Jupyter](notebooks/02-message-passing-by-hand.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/02-message-passing-by-hand.ipynb)
...
- 03. [Random Walk](chapters/03-random-walk/README.md) - Sample local neighborhoods as sequences.
  ...
  - Notebook - [Jupyter](notebooks/03-random-walk.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/03-random-walk.ipynb)
...
- 04. [DeepWalk](chapters/04-deepwalk/README.md) - Convert walk contexts into node embeddings.
  ...
  - Notebook - [Jupyter](notebooks/04-deepwalk.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/04-deepwalk.ipynb)
...
- 05. [Node2Vec](chapters/05-node2vec/README.md) - Tune local-vs-outward similarity with biased walks.
  ...
  - Notebook - [Jupyter](notebooks/05-node2vec.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/05-node2vec.ipynb)
...
- 06. [GCN](chapters/06-gcn/README.md) - Train a suspicious-node classifier with normalized aggregation.
  ...
  - Notebook - [Jupyter](notebooks/06-gcn.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/06-gcn.ipynb)
...
- 07. [GraphSAGE](chapters/07-graphsage/README.md) - Score new nodes with sampled neighborhood features.
  ...
  - Notebook - [Jupyter](notebooks/07-graphsage.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/07-graphsage.ipynb)
...
- 08. [GAT](chapters/08-gat/README.md) - Inspect neighbor attention weights.
  ...
  - Notebook - [Jupyter](notebooks/08-gat.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/08-gat.ipynb)
...
- 09. [Link Prediction](chapters/09-link-prediction/README.md) - Rank missing user-item relations as recommendation candidates.
  ...
  - Notebook - [Jupyter](notebooks/09-link-prediction.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/09-link-prediction.ipynb)
...
- 10. [Graph Classification](chapters/10-graph-classification/README.md) - Pool node embeddings into graph-level predictions.
  ...
  - Notebook - [Jupyter](notebooks/10-graph-classification.ipynb) / [Colab](https://colab.research.google.com/github/rlaope/gnn-tutorial/blob/main/notebooks/10-graph-classification.ipynb)
